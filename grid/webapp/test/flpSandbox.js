		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Learning Grid",
									"targetURL": "#sync5gridgrid-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5gridgrid-display": {
								"semanticObject": "sync5gridgrid",
								"action": "display",
								"description": "An SAP Grid Fiori application.",
								"title": "Learning Grid",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.grid.grid",
									"url": sap.ui.require.toUrl("sync5/grid/grid")
								}
							}
						}
					}
