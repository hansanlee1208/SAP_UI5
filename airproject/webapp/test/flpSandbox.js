		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Resevation Airline",
									"targetURL": "#airlineairproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"airlineairproject-display": {
								"semanticObject": "airlineairproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=airline.airproject",
									"url": sap.ui.require.toUrl("airline/airproject")
								}
							}
						}
					}
