		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "oData URL connection",
									"targetURL": "#odataurlodataurl-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"odataurlodataurl-display": {
								"semanticObject": "odataurlodataurl",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=odata.url.odataurl",
									"url": sap.ui.require.toUrl("odata/url/odataurl")
								}
							}
						}
					}
