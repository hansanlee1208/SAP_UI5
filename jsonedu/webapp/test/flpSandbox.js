		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Learning Fiori with Json",
									"targetURL": "#cl3jsonjsonedu-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl3jsonjsonedu-display": {
								"semanticObject": "cl3jsonjsonedu",
								"action": "display",
								"description": "Json Fiori application.",
								"title": "Learning Fiori with Json",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl3.json.jsonedu",
									"url": sap.ui.require.toUrl("cl3/json/jsonedu")
								}
							}
						}
					}
