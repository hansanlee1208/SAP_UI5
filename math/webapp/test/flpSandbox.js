					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mathmatics sample",
									"targetURL": "#cl3mathmath-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl3mathmath-display": {
								"semanticObject": "cl3mathmath",
								"action": "display",
								"description": "An Math Fiori application.",
								"title": "Mathmatics sample",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl3.math.math",
									"url": sap.ui.require.toUrl("cl3/math/math")
								}
							}
						}
					}
