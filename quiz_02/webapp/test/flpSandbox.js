					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "quiz_02 TODOLIST",
									"targetURL": "#quizquiz02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"quizquiz02-display": {
								"semanticObject": "quizquiz02",
								"action": "display",
								"description": "An SAP Fiori application. ToDoList",
								"title": "quiz_02 TODOLIST",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=quiz.quiz02",
									"url": sap.ui.require.toUrl("quiz/quiz02")
								}
							}
						}
					}
