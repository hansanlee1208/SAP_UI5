		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "8th day",
									"targetURL": "#sync5cl3day8study-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5cl3day8study-display": {
								"semanticObject": "sync5cl3day8study",
								"action": "display",
								"description": "An 8th Fiori application.",
								"title": "8th day",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.cl3.day8study",
									"url": sap.ui.require.toUrl("sync5/cl3/day8study")
								}
							}
						}
					}
