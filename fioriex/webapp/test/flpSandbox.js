		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Example",
									"targetURL": "#fiorinsfioriex-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fiorinsfioriex-display": {
								"semanticObject": "fiorinsfioriex",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fiorins.fioriex",
									"url": sap.ui.require.toUrl("fiorins/fioriex")
								}
							}
						}
					}
