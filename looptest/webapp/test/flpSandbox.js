		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Loop control",
									"targetURL": "#sync5cl3looptest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5cl3looptest-display": {
								"semanticObject": "sync5cl3looptest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.cl3.looptest",
									"url": sap.ui.require.toUrl("sync5/cl3/looptest")
								}
							}
						}
					}
