		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX1 평가",
									"targetURL": "#sync5cl3ux1exam01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5cl3ux1exam01-display": {
								"semanticObject": "sync5cl3ux1exam01",
								"action": "display",
								"description": "UX1 평",
								"title": "UX1 평가",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.cl3.ux1exam01",
									"url": sap.ui.require.toUrl("sync5/cl3/ux1exam01")
								}
							}
						}
					}
