					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Nested view test",
									"targetURL": "#cl3nswork03-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl3nswork03-display": {
								"semanticObject": "cl3nswork03",
								"action": "display",
								"description": "Nested View",
								"title": "Nested view test",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl3ns.work03",
									"url": sap.ui.require.toUrl("cl3ns/work03")
								}
							}
						}
					}
