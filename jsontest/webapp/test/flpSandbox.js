		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sync5cl3jsontest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5cl3jsontest-display": {
								"semanticObject": "sync5cl3jsontest",
								"action": "display",
								"description": "An JSON Fiori application.",
								"title": "Json model test",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.cl3.jsontest",
									"url": sap.ui.require.toUrl("sync5/cl3/jsontest")
								}
							}
						}
					}
