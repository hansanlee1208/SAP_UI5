		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mentoring Day 1",
									"targetURL": "#mentor01day01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mentor01day01-display": {
								"semanticObject": "mentor01day01",
								"action": "display",
								"description": "Mentoring Day 1",
								"title": "Mentoring Day 1",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mentor01.day01",
									"url": sap.ui.require.toUrl("mentor01/day01")
								}
							}
						}
					}
