		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sync5cl3fiori17-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5cl3fiori17-display": {
								"semanticObject": "sync5cl3fiori17",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.cl3.fiori17",
									"url": sap.ui.require.toUrl("sync5/cl3/fiori17")
								}
							}
						}
					}
