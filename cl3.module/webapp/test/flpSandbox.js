		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "WorkThrough",
									"targetURL": "#cl3workcl3module-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl3workcl3module-display": {
								"semanticObject": "cl3workcl3module",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl3.work.cl3.module",
									"url": sap.ui.require.toUrl("cl3/work/cl3/module")
								}
							}
						}
					}
