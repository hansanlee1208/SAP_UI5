		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "AM_Test_Fiori",
									"targetURL": "#sync5cl3fiori16-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5cl3fiori16-display": {
								"semanticObject": "sync5cl3fiori16",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.cl3.fiori16",
									"url": sap.ui.require.toUrl("sync5/cl3/fiori16")
								}
							}
						}
					}
